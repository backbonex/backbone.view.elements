...
define([
    ...
    var ElementsView = Backbone.View.extend(/**@lends ElementsView#*/{
         ...
         * @param {...String} [placeholders] values for placeholders, see examples
         ...
         * @param {String|Array.<String>} cls class name
        ...
        /**
         * Returns true if selector descried in {@link ElementsView#_classes} or {@link ElementsView#_selectors}
