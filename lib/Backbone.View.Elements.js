...
define([
    ...
    // remember origin Backbone.View methods for safe redefining
     ...
     */
    _.extend(Backbone.View.prototype, /**@lends ElementsView*/{
        /**
        ...
        /**
         * Redefined {@link Backbone.View} constructor
         * @protected
         * @constructs
         */
        initialize: function () {
            var originResult = initialize.apply(this, arguments);
        ...
        setElement: function () {
            var originResult = setElement.apply(this, arguments);

            /**
             * Data attributes of {@link Backbone.View.$el}. Keys are in camelCase
             * @type {Object.<string, string>}
             * @protected
             * @see {@link jQuery.data}
             */
        ...
        /**
         * Возвращает css класс элемента по его имени, классы берутся из {@link ElementsView._classes}
         ...
         * @param {String|Array.<String>|Backbone.$} [elem=this.$el]
         * @param {Array} [methodArgs]
         * @returns {Boolean|Backbone.$}
         * @private
         */
         ...
         * @param {string} name
         * @param {HTMLElement|Backbone.$|string} content
         * @protected
         */
